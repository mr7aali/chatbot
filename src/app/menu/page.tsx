...
const MenuPage = () => {
  ...
  useEffect(() => {
    fetch("/api/categories")
      .then((res) => res.json())
      .then((data: Category[]) => {
        setCategories(data), setTag(data[0].name);
      });
    ...
    <section className="py-12">
      {categories && menuItems && (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 px-4 lg:container">
