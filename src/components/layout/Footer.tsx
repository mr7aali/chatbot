...
const Footer = () => {
  return (
    <footer className="bg-gray-950 pt-12 pb-36">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 mb-6 px-10 lg:px-48">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-400">
            Passionate about delivering unforgettable pizza experiences with
            every savory slice we create.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-6 grid space-y-2 text-gray-400">
            <p>
              <a className="inline-flex gap-x-2 hover:text-gray-200" href="/">
                Dine-In
              </a>
            </p>
            <p>
